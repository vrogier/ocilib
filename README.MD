...
Current releases up to version 4.2.0 are licensed under **LGPL v2.1**

From version 4.2.1, OCILIB will be relicensed under **Apache License, Version 2.0** - see [LICENSE file](license.txt)
