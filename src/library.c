...
{
    {OCI_UNKNOWN                             , TEXT("UNKNOWN")                        },
    {OCI_SFC_CREATE_TABLE                    , TEXT("CREATE TABLE")                   },
    {OCI_SFC_INSERT                          , TEXT("INSERT")                         },
    {OCI_SFC_SELECT                          , TEXT("SELECT")                         },
    {OCI_SFC_CREATE_CLUSTER                  , TEXT("CREATE CLUSTER")                 },
    {OCI_SFC_ALTER_CLUSTER                   , TEXT("ALTER CLUSTER")                  },
    {OCI_SFC_UPDATE                          , TEXT("UPDATE")                         },
    {OCI_SFC_DELETE                          , TEXT("DELETE")                         },
    {OCI_SFC_DROP_CLUSTER                    , TEXT("DROP CLUSTER")                   },
    {OCI_SFC_CREATE_INDEX                    , TEXT("CREATE INDEX")                   },
    {OCI_SFC_DROP_INDEX                      , TEXT("DROP INDEX")                     },
    {OCI_SFC_ALTER_INDEX                     , TEXT("ALTER INDEX")                    },
    {OCI_SFC_DROP_TABLE                      , TEXT("DROP TABLE")                     },
    {OCI_SFC_CREATE_SEQUENCE                 , TEXT("CREATE SEQUENCE")                },
    {OCI_SFC_ALTER_SEQUENCE                  , TEXT("ALTER SEQUENCE")                 },
    {OCI_SFC_ALTER_TABLE                     , TEXT("ALTER TABLE")                    },
    {OCI_SFC_DROP_SEQUENCE                   , TEXT("DROP SEQUENCE")                  },
    {OCI_SFC_GRANT_OBJECT                    , TEXT("GRANT OBJECT")                   },
    {OCI_SFC_REVOKE_OBJECT                   , TEXT("REVOKE OBJECT")                  },
    {OCI_SFC_CREATE_SYNONYM                  , TEXT("CREATE SYNONYM")                 },
    {OCI_SFC_DROP_SYNONYM                    , TEXT("DROP SYNONYM")                   },
    {OCI_SFC_CREATE_VIEW                     , TEXT("CREATE VIEW")                    },
    {OCI_SFC_DROP_VIEW                       , TEXT("DROP VIEW")                      },
    {OCI_SFC_VALIDATE_INDEX                  , TEXT("VALIDATE INDEX")                 },
    {OCI_SFC_CREATE_PROCEDURE                , TEXT("CREATE PROCEDURE")               },
    {OCI_SFC_ALTER_PROCEDURE                 , TEXT("ALTER PROCEDURE")                },
    {OCI_SFC_LOCK                            , TEXT("LOCK")                           },
    {OCI_SFC_NO_OP                           , TEXT("NO-OP")                          },
    {OCI_SFC_RENAME                          , TEXT("RENAME")                         },
    {OCI_SFC_COMMENT                         , TEXT("COMMENT")                        },
    {OCI_SFC_AUDIT_OBJECT                    , TEXT("AUDIT OBJECT")                   },
    {OCI_SFC_NOAUDIT_OBJECT                  , TEXT("NOAUDIT OBJECT")                 },
    {OCI_SFC_CREATE_DATABASE_LINK            , TEXT("CREATE DATABASE LINK")           },
    {OCI_SFC_DROP_DATABASE_LINK              , TEXT("DROP DATABASE LINK")             },
    {OCI_SFC_CREATE_DATABASE                 , TEXT("CREATE DATABASE")                },
    {OCI_SFC_ALTER_DATABASE                  , TEXT("ALTER DATABASE")                 },
    {OCI_SFC_CREATE_ROLLBACK_SEG             , TEXT("CREATE ROLLBACK SEG")            },
    {OCI_SFC_ALTER_ROLLBACK_SEG              , TEXT("ALTER ROLLBACK SEG")             },
    {OCI_SFC_DROP_ROLLBACK_SEG               , TEXT("DROP ROLLBACK SEG")              },
    {OCI_SFC_CREATE_TABLESPACE               , TEXT("CREATE TABLESPACE")              },
    {OCI_SFC_ALTER_TABLESPACE                , TEXT("ALTER TABLESPACE")               },
    {OCI_SFC_DROP_TABLESPACE                 , TEXT("DROP TABLESPACE")                },
    {OCI_SFC_ALTER_SESSION                   , TEXT("ALTER SESSION")                  },
    {OCI_SFC_ALTER_USER                      , TEXT("ALTER USER")                     },
    {OCI_SFC_COMMIT                          , TEXT("COMMIT")                         },
    {OCI_SFC_ROLLBACK                        , TEXT("ROLLBACK")                       },
    {OCI_SFC_SAVEPOINT                       , TEXT("SAVEPOINT")                      },
    {OCI_SFC_PL_SQL_EXECUTE                  , TEXT("PL/SQL EXECUTE")                 },
    {OCI_SFC_SET_TRANSACTION                 , TEXT("SET TRANSACTION")                },
    {OCI_SFC_ALTER_SYSTEM                    , TEXT("ALTER SYSTEM")                   },
    {OCI_SFC_EXPLAIN                         , TEXT("EXPLAIN")                        },
    {OCI_SFC_CREATE_USER                     , TEXT("CREATE USER")                    },
    {OCI_SFC_CREATE_ROLE                     , TEXT("CREATE ROLE")                    },
    {OCI_SFC_DROP_USER                       , TEXT("DROP USER")                      },
    {OCI_SFC_DROP_ROLE                       , TEXT("DROP ROLE")                      },
    {OCI_SFC_SET_ROLE                        , TEXT("SET ROLE")                       },
    {OCI_SFC_CREATE_SCHEMA                   , TEXT("CREATE SCHEMA")                  },
    {OCI_SFC_CREATE_CONTROL_FILE             , TEXT("CREATE CONTROL FILE")            },
    {OCI_SFC_ALTER_TRACING                   , TEXT("ALTER TRACING")                  },
    {OCI_SFC_CREATE_TRIGGER                  , TEXT("CREATE TRIGGER")                 },
    {OCI_SFC_ALTER_TRIGGER                   , TEXT("ALTER TRIGGER")                  },
    {OCI_SFC_DROP_TRIGGER                    , TEXT("DROP TRIGGER")                   },
    {OCI_SFC_ANALYZE_TABLE                   , TEXT("ANALYZE TABLE")                  },
    {OCI_SFC_ANALYZE_INDEX                   , TEXT("ANALYZE INDEX")                  },
    {OCI_SFC_ANALYZE_CLUSTER                 , TEXT("ANALYZE CLUSTER")                },
    {OCI_SFC_CREATE_PROFILE                  , TEXT("CREATE PROFILE")                 },
    {OCI_SFC_DROP_PROFILE                    , TEXT("DROP PROFILE")                   },
    {OCI_SFC_ALTER_PROFILE                   , TEXT("ALTER PROFILE")                  },
    {OCI_SFC_DROP_PROCEDURE                  , TEXT("DROP PROCEDURE")                 },
    {OCI_SFC_ALTER_RESOURCE_COST             , TEXT("ALTER RESOURCE COST")            },
    {OCI_SFC_CREATE_MATERIALIZED_VIEW_LOG    , TEXT("CREATE MATERIALIZED VIEW LOG")   },
    {OCI_SFC_ALTER_MATERIALIZED_VIEW_LOG     , TEXT("ALTER MATERIALIZED VIEW LOG")    },
    {OCI_SFC_DROP_MATERIALIZED_VIEW_LOG      , TEXT("DROP MATERIALIZED VIEW LOG")     },
    {OCI_SFC_CREATE_MATERIALIZED_VIEW        , TEXT("CREATE MATERIALIZED VIEW")       },
    {OCI_SFC_ALTER_MATERIALIZED_VIEW         , TEXT("ALTER MATERIALIZED VIEW")        },
    {OCI_SFC_DROP_MATERIALIZED_VIEW          , TEXT("DROP MATERIALIZED VIEW")         },
    {OCI_SFC_CREATE_TYPE                     , TEXT("CREATE TYPE")                    },
    {OCI_SFC_DROP_TYPE                       , TEXT("DROP TYPE")                      },
    {OCI_SFC_ALTER_ROLE                      , TEXT("ALTER ROLE")                     },
    {OCI_SFC_ALTER_TYPE                      , TEXT("ALTER TYPE")                     },
    {OCI_SFC_CREATE_TYPE_BODY                , TEXT("CREATE TYPE BODY")               },
    {OCI_SFC_ALTER_TYPE_BODY                 , TEXT("ALTER TYPE BODY")                },
    {OCI_SFC_DROP_TYPE_BODY                  , TEXT("DROP TYPE BODY")                 },
    {OCI_SFC_DROP_LIBRARY                    , TEXT("DROP LIBRARY")                   },
    {OCI_SFC_TRUNCATE_TABLE                  , TEXT("TRUNCATE TABLE")                 },
    {OCI_SFC_TRUNCATE_CLUSTER                , TEXT("TRUNCATE CLUSTER")               },
    {OCI_SFC_ALTER_VIEW                      , TEXT("ALTER VIEW")                     },
    {OCI_SFC_SET_CONSTRAINTS                 , TEXT("SET CONSTRAINTS")                },
    {OCI_SFC_CREATE_FUNCTION                 , TEXT("CREATE FUNCTION")                },
    {OCI_SFC_ALTER_FUNCTION                  , TEXT("ALTER FUNCTION")                 },
    {OCI_SFC_DROP_FUNCTION                   , TEXT("DROP FUNCTION")                  },
    {OCI_SFC_CREATE_PACKAGE                  , TEXT("CREATE PACKAGE")                 },
    {OCI_SFC_ALTER_PACKAGE                   , TEXT("ALTER PACKAGE")                  },
    {OCI_SFC_DROP_PACKAGE                    , TEXT("DROP PACKAGE")                   },
    {OCI_SFC_CREATE_PACKAGE_BODY             , TEXT("CREATE PACKAGE BODY")            },
    {OCI_SFC_ALTER_PACKAGE_BODY              , TEXT("ALTER PACKAGE BODY")             },
    {OCI_SFC_DROP_PACKAGE_BODY               , TEXT("DROP PACKAGE BODY")              },
    {OCI_SFC_LOGON                           , TEXT("LOGON")                          },
    {OCI_SFC_LOGOFF                          , TEXT("LOGOFF")                         },
    {OCI_SFC_LOGOFF_BY_CLEANUP               , TEXT("LOGOFF BY CLEANUP")              },
    {OCI_SFC_SESSION_REC                     , TEXT("SESSION REC")                    },
    {OCI_SFC_SYSTEM_AUDIT                    , TEXT("SYSTEM AUDIT")                   },
    {OCI_SFC_SYSTEM_NOAUDIT                  , TEXT("SYSTEM NOAUDIT")                 },
    {OCI_SFC_AUDIT_DEFAULT                   , TEXT("AUDIT DEFAULT")                  },
    {OCI_SFC_NOAUDIT_DEFAULT                 , TEXT("NOAUDIT DEFAULT")                },
    {OCI_SFC_SYSTEM_GRANT                    , TEXT("SYSTEM GRANT")                   },
    {OCI_SFC_SYSTEM_REVOKE                   , TEXT("SYSTEM REVOKE")                  },
    {OCI_SFC_CREATE_PUBLIC_SYNONYM           , TEXT("CREATE PUBLIC SYNONYM")          },
    {OCI_SFC_DROP_PUBLIC_SYNONYM             , TEXT("DROP PUBLIC SYNONYM")            },
    {OCI_SFC_CREATE_PUBLIC_DATABASE_LINK     , TEXT("CREATE PUBLIC DATABASE LINK")    },
    {OCI_SFC_DROP_PUBLIC_DATABASE_LINK       , TEXT("DROP PUBLIC DATABASE LINK")      },
    {OCI_SFC_GRANT_ROLE                      , TEXT("GRANT ROLE")                     },
    {OCI_SFC_REVOKE_ROLE                     , TEXT("REVOKE ROLE")                    },
    {OCI_SFC_EXECUTE_PROCEDURE               , TEXT("EXECUTE PROCEDURE")              },
    {OCI_SFC_USER_COMMENT                    , TEXT("USER COMMENT")                   },
    {OCI_SFC_ENABLE_TRIGGER                  , TEXT("ENABLE TRIGGER")                 },
    {OCI_SFC_DISABLE_TRIGGER                 , TEXT("DISABLE TRIGGER")                },
    {OCI_SFC_ENABLE_ALL_TRIGGERS             , TEXT("ENABLE ALL TRIGGERS")            },
    {OCI_SFC_DISABLE_ALL_TRIGGERS            , TEXT("DISABLE ALL TRIGGERS")           },
    {OCI_SFC_NETWORK_ERROR                   , TEXT("NETWORK ERROR")                  },
    {OCI_SFC_EXECUTE_TYPE                    , TEXT("EXECUTE TYPE")                   },
    {OCI_SFC_READ_DIRECTORY                  , TEXT("READ DIRECTORY")                 },
    {OCI_SFC_WRITE_DIRECTORY                 , TEXT("WRITE DIRECTORY")                },
    {OCI_SFC_FLASHBACK                       , TEXT("FLASHBACK")                      },
    {OCI_SFC_BECOME_USER                     , TEXT("BECOME USER")                    },
    {OCI_SFC_ALTER_MINING_MODEL              , TEXT("ALTER MINING MODEL")             },
    {OCI_SFC_SELECT_MINING_MODEL             , TEXT("SELECT MINING MODEL")            },
    {OCI_SFC_CREATE_MINING_MODEL             , TEXT("CREATE MINING MODEL")            },
    {OCI_SFC_ALTER_PUBLIC_SYNONYM            , TEXT("ALTER PUBLIC SYNONYM")           },
    {OCI_SFC_EXECUTE_DIRECTORY               , TEXT("EXECUTE DIRECTORY")              },
    {OCI_SFC_SQL_LOADER_DIRECT_PATH_LOAD     , TEXT("SQL*LOADER DIRECT PATH LOAD")    },
    {OCI_SFC_DATAPUMP_DIRECT_PATH_UNLOAD     , TEXT("DATAPUMP DIRECT PATH UNLOAD")    },
    {OCI_SFC_DATABASE_STARTUP                , TEXT("DATABASE STARTUP")               },
    {OCI_SFC_DATABASE_SHUTDOWN               , TEXT("DATABASE SHUTDOWN")              },
    {OCI_SFC_CREATE_SQL_TXLN_PROFILE         , TEXT("CREATE SQL TXLN PROFILE")        },
    {OCI_SFC_ALTER_SQL_TXLN_PROFILE          , TEXT("ALTER SQL TXLN PROFILE")         },
    {OCI_SFC_USE_SQL_TXLN_PROFILE            , TEXT("USE SQL TXLN PROFILE")           },
    {OCI_SFC_DROP_SQL_TXLN_PROFILE           , TEXT("DROP SQL TXLN PROFILE")          },
    {OCI_SFC_CREATE_MEASURE_FOLDER           , TEXT("CREATE MEASURE FOLDER")          },
    {OCI_SFC_ALTER_MEASURE_FOLDER            , TEXT("ALTER MEASURE FOLDER")           },
    {OCI_SFC_DROP_MEASURE_FOLDER             , TEXT("DROP MEASURE FOLDER")            },
    {OCI_SFC_CREATE_CUBE_BUILD_PROCESS       , TEXT("CREATE CUBE BUILD PROCESS")      },
    {OCI_SFC_ALTER_CUBE_BUILD_PROCESS        , TEXT("ALTER CUBE BUILD PROCESS")       },
    {OCI_SFC_DROP_CUBE_BUILD_PROCESS         , TEXT("DROP CUBE BUILD PROCESS")        },
    {OCI_SFC_CREATE_CUBE                     , TEXT("CREATE CUBE")                    },
    {OCI_SFC_ALTER_CUBE                      , TEXT("ALTER CUBE")                     },
    {OCI_SFC_DROP_CUBE                       , TEXT("DROP CUBE")                      },
    {OCI_SFC_CREATE_CUBE_DIMENSION           , TEXT("CREATE CUBE DIMENSION")          },
    {OCI_SFC_ALTER_CUBE_DIMENSION            , TEXT("ALTER CUBE DIMENSION")           },
    {OCI_SFC_DROP_CUBE_DIMENSION             , TEXT("DROP CUBE DIMENSION")            },
    {OCI_SFC_CREATE_DIRECTORY                , TEXT("CREATE DIRECTORY")               },
    {OCI_SFC_DROP_DIRECTORY                  , TEXT("DROP DIRECTORY")                 },
    {OCI_SFC_CREATE_LIBRARY                  , TEXT("CREATE LIBRARY")                 },
    {OCI_SFC_CREATE_JAVA                     , TEXT("CREATE JAVA")                    },
    {OCI_SFC_ALTER_JAVA                      , TEXT("ALTER JAVA")                     },
    {OCI_SFC_DROP_JAVA                       , TEXT("DROP JAVA")                      },
    {OCI_SFC_CREATE_OPERATOR                 , TEXT("CREATE OPERATOR")                },
    {OCI_SFC_CREATE_INDEXTYPE                , TEXT("CREATE INDEXTYPE")               },
    {OCI_SFC_DROP_INDEXTYPE                  , TEXT("DROP INDEXTYPE")                 },
    {OCI_SFC_ALTER_INDEXTYPE                 , TEXT("ALTER INDEXTYPE")                },
    {OCI_SFC_DROP_OPERATOR                   , TEXT("DROP OPERATOR")                  },
    {OCI_SFC_ASSOCIATE_STATISTICS            , TEXT("ASSOCIATE STATISTICS")           },
    {OCI_SFC_DISASSOCIATE_STATISTICS         , TEXT("DISASSOCIATE STATISTICS")        },
    {OCI_SFC_CALL_METHOD                     , TEXT("CALL METHOD")                    },
    {OCI_SFC_CREATE_SUMMARY                  , TEXT("CREATE SUMMARY")                 },
    {OCI_SFC_ALTER_SUMMARY                   , TEXT("ALTER SUMMARY")                  },
    {OCI_SFC_DROP_SUMMARY                    , TEXT("DROP SUMMARY")                   },
    {OCI_SFC_CREATE_DIMENSION                , TEXT("CREATE DIMENSION")               },
    {OCI_SFC_ALTER_DIMENSION                 , TEXT("ALTER DIMENSION")                },
    {OCI_SFC_DROP_DIMENSION                  , TEXT("DROP DIMENSION")                 },
    {OCI_SFC_CREATE_CONTEXT                  , TEXT("CREATE CONTEXT")                 },
    {OCI_SFC_DROP_CONTEXT                    , TEXT("DROP CONTEXT")                   },
    {OCI_SFC_ALTER_OUTLINE                   , TEXT("ALTER OUTLINE")                  },
    {OCI_SFC_CREATE_OUTLINE                  , TEXT("CREATE OUTLINE")                 },
    {OCI_SFC_DROP_OUTLINE                    , TEXT("DROP OUTLINE")                   },
    {OCI_SFC_UPDATE_INDEXES                  , TEXT("UPDATE INDEXES")                 },
    {OCI_SFC_ALTER_OPERATOR                  , TEXT("ALTER OPERATOR")                 },
    {OCI_SFC_CREATE_SPFILE                   , TEXT("CREATE SPFILE")                  },
    {OCI_SFC_CREATE_PFILE                    , TEXT("CREATE PFILE")                   },
    {OCI_SFC_MERGE                           , TEXT("MERGE")                          },
    {OCI_SFC_PASSWORD_CHANGE                 , TEXT("PASSWORD CHANGE")                },
    {OCI_SFC_ALTER_SYNONYM                   , TEXT("ALTER SYNONYM")                  },
    {OCI_SFC_ALTER_DISKGROUP                 , TEXT("ALTER DISKGROUP")                },
    {OCI_SFC_CREATE_DISKGROUP                , TEXT("CREATE DISKGROUP")               },
    {OCI_SFC_DROP_DISKGROUP                  , TEXT("DROP DISKGROUP")                 },
    {OCI_SFC_PURGE_RECYCLEBIN                , TEXT("PURGE RECYCLEBIN")               },
    {OCI_SFC_PURGE_DBA_RECYCLEBIN            , TEXT("PURGE DBA_RECYCLEBIN")           },
    {OCI_SFC_PURGE_TABLESPACE                , TEXT("PURGE TABLESPACE")               },
    {OCI_SFC_PURGE_TABLE                     , TEXT("PURGE TABLE")                    },
    {OCI_SFC_PURGE_INDEX                     , TEXT("PURGE INDEX")                    },
    {OCI_SFC_UNDROP_OBJECT                   , TEXT("UNDROP OBJECT")                  },
    {OCI_SFC_DROP_DATABASE                   , TEXT("DROP DATABASE")                  },
    {OCI_SFC_FLASHBACK_DATABASE              , TEXT("FLASHBACK DATABASE")             },
    {OCI_SFC_FLASHBACK_TABLE                 , TEXT("FLASHBACK TABLE")                },
    {OCI_SFC_CREATE_RESTORE_POINT            , TEXT("CREATE RESTORE POINT")           },
    {OCI_SFC_DROP_RESTORE_POINT              , TEXT("DROP RESTORE POINT")             },
    {OCI_SFC_PROXY_AUTHENTICATION_ONLY       , TEXT("PROXY AUTHENTICATION ONLY")      },
    {OCI_SFC_DECLARE_REWRITE_EQUIVALENCE     , TEXT("DECLARE REWRITE EQUIVALENCE")    },
    {OCI_SFC_ALTER_REWRITE_EQUIVALENCE       , TEXT("ALTER REWRITE EQUIVALENCE")      },
    {OCI_SFC_DROP_REWRITE_EQUIVALENCE        , TEXT("DROP REWRITE EQUIVALENCE")       },
    {OCI_SFC_CREATE_EDITION                  , TEXT("CREATE EDITION")                 },
    {OCI_SFC_ALTER_EDITION                   , TEXT("ALTER EDITION")                  },
    {OCI_SFC_DROP_EDITION                    , TEXT("DROP EDITION")                   },
    {OCI_SFC_DROP_ASSEMBLY                   , TEXT("DROP ASSEMBLY")                  },
    {OCI_SFC_CREATE_ASSEMBLY                 , TEXT("CREATE ASSEMBLY")                },
    {OCI_SFC_ALTER_ASSEMBLY                  , TEXT("ALTER ASSEMBLY")                 },
    {OCI_SFC_CREATE_FLASHBACK_ARCHIVE        , TEXT("CREATE FLASHBACK ARCHIVE")       },
    {OCI_SFC_ALTER_FLASHBACK_ARCHIVE         , TEXT("ALTER FLASHBACK ARCHIVE")        },
    {OCI_SFC_DROP_FLASHBACK_ARCHIVE          , TEXT("DROP FLASHBACK ARCHIVE")         },
    {OCI_SFC_DEBUG_CONNECT                   , TEXT("DEBUG CONNECT")                  },
    {OCI_SFC_DEBUG_PROCEDURE                 , TEXT("DEBUG PROCEDURE")                },
    {OCI_SFC_ALTER_DATABASE_LINK             , TEXT("ALTER DATABASE LINK")            },
    {OCI_SFC_CREATE_PLUGGABLE_DATABASE       , TEXT("CREATE PLUGGABLE DATABASE")      },
    {OCI_SFC_ALTER_PLUGGABLE_DATABASE        , TEXT("ALTER PLUGGABLE DATABASE")       },
    {OCI_SFC_DROP_PLUGGABLE_DATABASE         , TEXT("DROP PLUGGABLE DATABASE")        },
    {OCI_SFC_CREATE_AUDIT_POLICY             , TEXT("CREATE AUDIT POLICY")            },
    {OCI_SFC_ALTER_AUDIT_POLICY              , TEXT("ALTER AUDIT POLICY")             },
    {OCI_SFC_DROP_AUDIT_POLICY               , TEXT("DROP AUDIT POLICY")              },
    {OCI_SFC_CODE_BASED_GRANT                , TEXT("CODE-BASED GRANT")               },
    {OCI_SFC_CODE_BASED_REVOKE               , TEXT("CODE-BASED REVOKE")              },
    {OCI_SFC_CREATE_LOCKDOWN_PROFILE         , TEXT("CREATE LOCKDOWN PROFILE")        },
    {OCI_SFC_DROP_LOCKDOWN_PROFILE           , TEXT("DROP LOCKDOWN PROFILE")          },
    {OCI_SFC_ALTER_LOCKDOWN_PROFILE          , TEXT("ALTER LOCKDOWN PROFILE")         },
    {OCI_SFC_TRANSLATE_SQL                   , TEXT("TRANSLATE SQL")                  },
    {OCI_SFC_ADMINISTER_KEY_MANAGEMENT       , TEXT("ADMINISTER KEY MANAGEMENT")      },
    {OCI_SFC_CREATE_MATERIALIZED_ZONEMAP     , TEXT("CREATE MATERIALIZED ZONEMAP")    },
    {OCI_SFC_ALTER_MATERIALIZED_ZONEMAP      , TEXT("ALTER MATERIALIZED ZONEMAP")     },
    {OCI_SFC_DROP_MATERIALIZED_ZONEMAP       , TEXT("DROP MATERIALIZED ZONEMAP")      },
    {OCI_SFC_DROP_MINING_MODEL               , TEXT("DROP MINING MODEL")              },
    {OCI_SFC_CREATE_ATTRIBUTE_DIMENSION      , TEXT("CREATE ATTRIBUTE DIMENSION")     },
    {OCI_SFC_ALTER_ATTRIBUTE_DIMENSION       , TEXT("ALTER ATTRIBUTE DIMENSION")      },
    {OCI_SFC_DROP_ATTRIBUTE_DIMENSION        , TEXT("DROP ATTRIBUTE DIMENSION")       },
    {OCI_SFC_CREATE_HIERARCHY                , TEXT("CREATE HIERARCHY")               },
    {OCI_SFC_ALTER_HIERARCHY                 , TEXT("ALTER HIERARCHY")                },
    {OCI_SFC_DROP_HIERARCHY                  , TEXT("DROP HIERARCHY")                 },
    {OCI_SFC_CREATE_ANALYTIC_VIEW            , TEXT("CREATE ANALYTIC VIEW")           },
    {OCI_SFC_ALTER_ANALYTIC_VIEW             , TEXT("ALTER ANALYTIC VIEW")            },
    {OCI_SFC_DROP_ANALYTIC_VIEW              , TEXT("DROP ANALYTIC VIEW")             },
    {OCI_SFC_ALTER_PUBLIC_DATABASE_LINK      , TEXT("ALTER PUBLIC DATABASE LINK")     }
};
