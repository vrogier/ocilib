...
/* ------------------------------------------------------------------------ *
 * $Id: connection.c, v 3.8.0 2010-10-09 19:30 Vincent Rogier $
 * ------------------------------------------------------------------------ */
...
OCI_Connection * OCI_ConnectionAllocate(OCI_Pool    *pool,
                                        const mtext *db,
                                        const mtext *user,
                                        const mtext *pwd,
                                        unsigned int mode)
...
boolean OCI_API OCI_SetSessionTag(OCI_Connection *con, const mtext *tag)
{
    boolean res = TRUE;
