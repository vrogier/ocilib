...
)
{
    ...
    if (msg)
    {
        ...
        res = OCI_SUCCESSFUL(OCI_DescriptorAlloc((dvoid * ) msg->typinf->con->env,
                                                 (dvoid **) &msg->proph,
...
)
{
    ...
    OCI_CHECK_COMPAT(msg->typinf->con, msg->typinf->typecode != OCI_UNKNOWN, NULL);
