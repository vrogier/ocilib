...
OCI_Agent * OCI_AgentInit(OCI_Connection *con, OCI_Agent **pagent,
                          OCIAQAgent *handle, const mtext *name, 
                          const mtext *address)
{
...
OCI_Agent * OCI_API OCI_AgentCreate(OCI_Connection *con, 
                                    const mtext *name, 
                                    const mtext *address)
{
    OCI_Agent *agent = NULL;
...
boolean OCI_API OCI_AgentFree(OCI_Agent *agent)
{
    boolean res = TRUE;
...
const mtext * OCI_API OCI_AgentGetName(OCI_Agent *agent)
{
    boolean res = TRUE;
...
boolean OCI_API OCI_AgentSetName(OCI_Agent *agent, const mtext *name)
{
    boolean res = TRUE;
...
const mtext * OCI_API OCI_AgentGetAddress(OCI_Agent *agent)
{
    boolean res = TRUE;
...
boolean OCI_API OCI_AgentSetAddress(OCI_Agent *agent, const mtext *address)
{
    boolean res = TRUE;
